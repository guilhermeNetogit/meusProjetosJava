...
public class TesteCasting {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("pessoaProfessor é do tipo Aluno → " + (
	    	    (pessoaProfessor instanceof Aluno)
	    	        ? "sim"
	    	        : "não"
	    	));
	    System.out.println("aluno3 é do tipo Professor → " + (
	    	    (aluno3 instanceof Professor)
	    	        ? "sim"
	    	        : "não"
	    	));
	    System.out.println("alunoRef é do tipo Aluno → " + (
	    	    (alunoRef instanceof Aluno)
	    	        ? "sim"
	    	        : "não"
	    	));
	    System.out.println("professor2 é do tipo Professor → " + (
	    	    (professor2 instanceof Professor)
	    	        ? "sim"
	    	        : "não"
	    	));
	    ...
	    if (alunoRef instanceof Aluno aluno) {
	        ...
	        // System.out.println("CPF: " + aluno.getCpf());   // descomente se existir getCpf()
