...
public class StringFormat2 {// Eclipse -> Github @guilhermeNetogit 26/03/2026 23:27:43
	...
	public static void main(String[] args) {
		...
		Pessoa pessoa = new Pessoa(Integer.parseInt(infos[0])
				, infos[1], cpfLimpo , Integer.parseInt(infos[3])
				, infos[4], Integer.parseInt(infos[5]));
